    ...
    <main className="min-h-screen gradient-bg text-white flex items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50">Start hiring smarter with AI-powered interviews</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-panel rounded-2xl p-8 border border-white/10">
          ...
          <button
            ...
            className="w-full mt-8 py-3 px-4 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white font-medium rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
